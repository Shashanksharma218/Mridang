  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-[1]">
        <img src={mandala} alt="" className="hidden md:block absolute top-0 left-0 -translate-x-1/3 -translate-y-1/3 opacity-10 w-[600px] animate-spin-slow" />
        <img src={mandala} alt="" className="hidden md:block absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 opacity-10 w-[600px] animate-spin-slow" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-3">
          <p className="uppercase tracking-[0.4em] text-sm text-[#8A5A3D] font-bold">
            Mridang 2025 Presents
          </p>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-heading text-[#5C1E15] leading-tight drop-shadow-sm">
            Star Performers
          </h2>
          <p className="text-[#704832] max-w-2xl mx-auto font-serif text-lg italic">
            Get ready to witness the magic live.
          </p>
        </div>
